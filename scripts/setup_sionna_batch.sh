...
echo ""
echo " Optional: enable queue-based autoscaling for desiredvCpus"
echo "   ./scripts/setup_sionna_queue_autoscaling.sh \\"
echo "       --account-id $ACCOUNT_ID --region $REGION \\"
echo "       --queue-name $QUEUE_NAME --compute-environment $CE_NAME"
echo "=================================================="
